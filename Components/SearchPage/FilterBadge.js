...
const FIlterBadge =({data})=>{
    return(
        <div class="flex max-w-sm justify-center items-center m-1 text-xs p-2 text-white  rounded-full bg-blue-550 ">
        <div class="text-xs font-normal leading-none max-w-full ">{data}</div>
