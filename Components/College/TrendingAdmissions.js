  ...
  return (
    <div className="border-t">
      <div className="flex px-4 pt-4">
        ...
        />
        <div className="ml-4">
          <p className="font-normal">Chandigarh University</p>
      ...
      <div className="ml-4 mb-4 mt-0.5">
        <p className="text-blue-550 text-xs">Bachelor of technology , Master of technology </p>
        <p className="text-vs mt-0.5">Total fees: 5.5lakh | 4 Years | On Campus | Fulltime</p>
      </div>
    </div>
  );
};
