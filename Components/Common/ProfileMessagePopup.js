    ...
    return (
        <div className="grid grid-cols-10 mt-4 mx-4 border-b py-2">
            ...
            <div className="col-span-6">
                <p class="text-xs">
                    <span class="text-black font-black">Mathilda Brinker </span>
                    <p class="text-xs">Lorem ipsum dolor sit amet, consec adipiscing...</p>
                </p>
            </div>
            <div className="col-span-2">
                <p class="text-xs text-gray-500 text-right mx-1">10:30PM</p>
