...
const BestColleges = () => {
    ...
    return (
      <div className='py-4 px-2'>
        <div className='flex flex-row '>
          <img className='w-12 h-12 rounded-full ' src={college} alt="collegeIcon"/>
          <div className='mx-2'>
  ...
  return (
    <div className='bg-white border shadow-lg   rounded-lg flex flex-col  mx-2'>
      <header className='bg-green-550 w-full h-16 rounded-t-lg  flex items-center justify-center text-white'>
            {/* h-72 , h-12 */}
        <img
          src={school}
          alt='school icon'
