    ...
    <div className="flex flex-col px-4 p-2 ">
     ...
     <div className="flex flex-row justify-start mt-2 ">
      ...
      <hr className="bg-blue-550 font-bold w-2/4 text-blue-550 h-0.5 my-3" />
          ...
          <div className="my-2 flex flex-row flex-wrap max-w-lg">
            {badges.map(item=>(  <FIlterBadge data={item} />))}
          </div>
      <input
        className="appearance-none block bg-gray-200 text-gray-700  rounded-lg py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
        id="grid-first-name"
        type="text"
      ...
      <input type="range" max="100" className="bg-blue-550  my-2 text-blue-550" />
