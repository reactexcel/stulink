...
const NotificationSettings = () => {
  return (
    <div className="shadow p-12">
      ...
      <p className="text-xl text-gray-400">Select push and email notifications you'd like to receive.</p>
        {/* <div>
    ...
    <label class="items-center block">
       <input type="radio" class="form-radio" name="personal email" value="personal email"/>
        <span class="ml-2 text-xl text-gray-400">Send Me emails about my activity except emails i have unsubscribe from</span>
     </label>
    <label class="items-center block mt-3">
      <input type="radio" class="form-radio" name="service email" value="service announcements"/>
      <span class="ml-2 text-xl text-gray-400">Only send me required services announcements.</span>
     </label>
     </div>
