...
const ListItem = ({ show, setShow, index }) => {
  return (
    <div className=" shadow-lgOuter11 border rounded-xl my-6">
      <div className="flex justify-between p-4 bg-gray-220 rounded-xl text-xl">
...
const Faqs = () => {
  ...
  return (
    <div className="my-9 rounded-xl shadow-2xl border">
      <p className="text-blue-550 text-2xl font-black mt-8 text-center flex justify-center items-center">
