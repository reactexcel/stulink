  ...
  return (
    <div className="flex flex-col w-full   bg-gray-100">
      <div className="flex flex-row items-center border-b border-gray-400 justify-center p-4">
        ...
        <p className="font-medium text-xl font-Poppins text-black">Rooms</p>
      </div>
      <div className="mt-4">
            ...
            <div className="flex flex-row items-center ">
              ...
              <div className="flex flex-col items-start mx-4 flex-1">
                <div className="flex-row flex justify-between w-full">
                  <p className="font-semibold text-base font-Poppins text-black ">
                    Management
                  </p>
                  <p className="font-bold cursor-pointer">...</p>
                </div>

                <h1 className=" text-sm  uppercase text-gray-500 my-2">
                  68 Members
                </h1>
                <button
                  type="submit"
                  className="py-1 px-4 my-2  bg-blue-550 flex flex-row items-center justify-center rounded-sm transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105"
                >
                  <div className="flex-row flex items-center">
                    <p className="text-white font-Poppins font-medium text-sm mr-2">
                      Join Now
                    </p>
