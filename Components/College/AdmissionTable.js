        ...
        <div>
            <div className="grid grid-cols-2 pl-12 mt-5">
                <div className=" border-r-2">
                     <p className = " text-blue-550 text-base text-center border-t-2 border-b-2 p-3 font-black">EVENT</p>
                ...
                <div>
                    <p className ="text-blue-550 text-base text-center p-3 border-t-2 border-b-2 font-black">DATE</p>
